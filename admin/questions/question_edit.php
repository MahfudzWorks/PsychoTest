...
<div class="ml-64 mt-16 p-8 min-h-screen bg-gray-50">
  ...
  <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
    <div>
      ...
      <p class="text-gray-500 mt-1">Perbarui informasi dan isi soal psikotes yang sudah ada</p>
    </div>
    ...
    <form action="question_update.php" method="POST">
      ...
      <div class="mb-6">
        ...
        <select name="test_id" id="test_id" required
          ...
          <?php while ($test = mysqli_fetch_assoc($tests)): ?>
            <option value="<?= $test['id'] ?>" <?= ($test['id'] == $data['test_id']) ? 'selected' : '' ?>>
      ...
      <div class="mb-6">
        ...
        <textarea name="question" id="question" rows="5" required
          ...
          placeholder="Masukkan isi soal..."><?= htmlspecialchars($data['question']) ?></textarea>
      </div>
      ...
      <div class="flex flex-col sm:flex-row justify-end gap-3">
        ...
        <button type="submit"
          ...
          <i class="fa-solid fa-floppy-disk"></i> Perbarui Soal
        </button>
      </div>
